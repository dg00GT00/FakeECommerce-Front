...
import {createStyles, SvgIcon, Theme, useTheme} from "@material-ui/core";
...
const hoverGithub = makeStyles((theme: Theme) => createStyles({
    root: {
...
const GithubIcon: React.FunctionComponent = () => {
    const style = hoverGithub();

    return (
        <SvgIcon className={style.root}>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.merchandise}>
                    ...
                    <div className={styles.payment}>
                        ...
                        <div className={styles.divider}/>
                        <div className={styles.fake_creditcard}>
