...
const isPageNumber = (params: {
	[i: string]: any;
}): params is PageParamsType => {
...
const RouteValidation: React.FunctionComponent<
	RouteComponentProps<{ pageNumber: string }> & RouteValidationProps
> = (props) => {
